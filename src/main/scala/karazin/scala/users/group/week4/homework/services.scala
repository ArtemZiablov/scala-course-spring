...
object services:
  ...
  // Emulation
  def registerUser(username: String, password: String, email: String,
                   phone: String, birthDate: String, postalCode: String)
    ...
    EitherT[Future, DomainErrors, UserProfile](
      Future {
        ...
        */
        ...
        validation.validateRegistrationForm(username, 
            password, email, phone, birthDate, postalCode) /*In a case of success store the user in the db*/
